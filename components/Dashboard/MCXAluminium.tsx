...
export default function MCXAluminium() {
  ...
  const sseUrl = "http://148.135.138.22/mcx-aluminium/stream"; // Your actual SSE stream URL
  ...
  const fetchDataWithFetch = async (useSampleFallback: boolean = false) => {
    try {
...
//   }) => (
//     <div
//       className={`flex-1 flex items-center ${expanded ? "justify-center" : ""}`}
//     >
//       <div className="w-full">
//         <div
//           className={`flex flex-col ${
...
//                   </h3>
//                   <p className="text-2xs text-gray-700">
//                     Near-month contract price reflecting current market
//                     conditions.
//                   </p>
//                 </div>
...
//                   <h3 className="text-xs font-medium text-pink-800 mb-1">
//                     May Contract
//                   </h3>
//                   <p className="text-2xs text-gray-700">
//                     Further-out contract indicating longer-term market trends.
